...
import type { DailyIntervalPickerProps } from "@/components/ui-providers/date-pickers/interval/DailyIntervalPicker";
...
export const IntervalBasedPicker: FC<IntervalBasedPickerProps> = (props) => {
  ...
  return (
    <Popover modal={false}>
      <PopoverTrigger className="p-1 w-full">
        <Button
      ...
      <PopoverContent className="p-0 m-0 border-none w-auto min-w-[300px] max-w-[400px]">
        <Component {...props} />
      </PopoverContent>
    </Popover>
  );

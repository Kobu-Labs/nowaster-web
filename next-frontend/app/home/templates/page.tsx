      ...
      <div className="container mx-auto px-4 py-6 max-w-7xl">
        <div className="space-y-6">
          <div className="space-y-2">
            <Skeleton className="h-8 w-48 bg-gradient-to-r from-pink-200/60 to-purple-200/60 dark:from-pink-800/40 dark:to-purple-800/40" />
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {Array.from({ length: 6 }).map((_, i) => (
              <Card
                key={i}
                className="overflow-hidden border-pink-100/30 bg-gradient-to-br from-pink-50/20 to-purple-50/10 dark:border-pink-900/20 dark:from-pink-950/10 dark:to-purple-950/5"
              >
                <CardContent className="p-6">
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <Skeleton className="h-6 w-32 bg-gradient-to-r from-pink-200/50 to-purple-200/50 dark:from-pink-800/30 dark:to-purple-800/30" />
  ...
  if (q.isError) {
    return (
      <div className="container mx-auto px-4 py-6 max-w-7xl">
        <Alert
          variant="destructive"
          className="max-w-md mx-auto border-red-200/50 bg-gradient-to-r from-red-50/80 to-pink-50/40 dark:border-red-800/30 dark:from-red-950/50 dark:to-pink-950/20"
        >

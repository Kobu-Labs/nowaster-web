...
export const SessionAverageDurationProvider = (props: SessionAverageDurationProviderProps) => {
  ...
  return (
    <KpiCardUiProvider variant={"big_value"} value={formatTime(sessions || 0)} title={"Average session duration"}>
      <Hourglass />
    </KpiCardUiProvider>);
};

import { VisibilityFlags } from "@/api/definitions/models/user";
...
export class VisibilityUtils {
  ...
  private static readonly FRIENDS = 1 << 0; // 1
  ...
  static getLabels() {
    return {
      private: { title: "Private", description: "Only you can see your activity" },
      friends: { title: "Friends", description: "Your friends can see your activity" },
      groups: { title: "Groups", description: "Group members can see your activity" },
      public: { title: "Public", description: "Everyone can see your activity" },
    };
  }
}
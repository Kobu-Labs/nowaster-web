    ...
    <AuthProvider>
      <div className="min-h-screen">
        <div className="flex min-h-screen items-center justify-center w-full">
          <div className="lg:flex  lg:flex-col lg:justify-center lg:px-8 xl:px-12 items-center w-full">
            <div className="w-full max-w-5xl">
              ...
              <div className="flex flex-col md:flex-row w-full items-center justify-center px-4 gap-4">
                            ...
                            <SignUp.Step name="continue">
                              <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm dark:bg-gray-800/80 w-full max-w-sm mx-auto">
                                <CardHeader className="space-y-1 pb-6">
                                  ...
                                  <CardDescription className="text-center text-gray-600 dark:text-gray-300">
                                    Choose a username to personalize your
                                    account
                                  </CardDescription>
                                </CardHeader>
                                <CardContent>

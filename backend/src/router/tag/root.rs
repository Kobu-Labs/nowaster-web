...
#[instrument( skip(state), fields(user_id = %actor, tag_id = %tag_id))]
...
#[instrument( skip(state), fields(user_id = %actor, tag_id = %payload.tag_id, category_id = %payload.category_id))]

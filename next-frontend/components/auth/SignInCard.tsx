...
const SandboxSignIn: FC = () => {
  ...
  const [previousUsername] = useState(() => Cookies.get(SANDBOX_LAST_USER_KEY) ?? null);
...
type SignInCardProps = {
  existingUser: null | User;
};

export const SignInCard: FC<SignInCardProps> = ({ existingUser }) => {
  const router = useRouter();
